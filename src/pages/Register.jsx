  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 transition-colors duration-300 ${
      ...
      <div className="bg-white dark:bg-secondary rounded-2xl shadow-xl p-8 max-w-md w-full">
        ...
        <h2 className="text-2xl font-bold text-center text-secondary dark:text-white mb-2">Create Account</h2>
        <p className="text-gray-500 dark:text-gray-400 text-center mb-6">Join AmakaziWatch to make a difference</p>
        ...
        >
          {googleLoading ? <LoadingSpinner size="sm" /> : <><Chrome className="w-5 h-5" /> Sign up with Google</>}
        </button>

        <div className="relative my-4">
          <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-gray-300 dark:border-gray-600"></div></div>
          <div className="relative flex justify-center text-sm"><span className="px-2 bg-white dark:bg-secondary text-gray-500 dark:text-gray-400">or register with email</span></div>
        </div>
