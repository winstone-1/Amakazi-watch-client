  ...
  return (
    <div className="transition-colors duration-300">
      <div className={`rounded-2xl p-8 backdrop-blur-xl border ${
        ...
        <h1 className="text-2xl font-bold text-secondary dark:text-white mb-4">ResourceInventory</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-6">This is the ResourceInventory feature page.</p>
